              ...
              <div className="md:flex-1 px-4">
                ...
                <div className="mb-4">
                  ...
                  {/* show more details btn */}
                   <Link to={`/product/${data.id}`} className="mt-[10px] bg-gray-200 text-gray-900 py-2 px-4 rounded-full font-bold mr-2 inline-block z-[0] button_hover_regsiter relative overflow-hidden hover:text-white">
                     Show More Details
                    </Link>
                  {/* show more details btn */}
                </div>
